...
const AppDrawerNavigator=createDrawerNavigator({SideDrawer:{screen:TabNavigator},SettingScreen:{screen:SettingScreen},MyTradesScreen:{screen:MyTradesScreen}},{contentComponent:SideDrawer},{initialRouteName:'SideDrawer'})
